hereأهلاً بك يا سعيد. قمت بتحديث الكود الخاص بك بالكامل بناءً على طلباتك:
 1. **تحديث النماذج:** تم استبدال النماذج القديمة بـ gemini-3.5-flash و gemini-3.1-flash-lite في السايدبار وفي إعدادات التهيئة.
 2. **إزالة النجوم:** تم حذف جميع الرموز ** (التي تجعل النص عريضاً) من الردود التلقائية، ومن نصوص الترحيب، ومن واجهة المحادثة، ليكون النص بسيطاً وواضحاً كما طلبت.
هذا هو الكود المحدث بالكامل:
```python
