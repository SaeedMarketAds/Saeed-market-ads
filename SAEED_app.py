...
# 💡 ربط الملفات بالأسماء الحقيقية الدقيقة الموجودة في مستودع جيت هاب الخاص بك:
saeed_image_path = os.path.join(BASE_DIR, "saeed_avatar.jpg")  # تم التعديل إلى الاسم الحقيقي
robot_image_path = os.path.join(BASE_DIR, "ROBOT.jpg")          # اسم صورة الروبوت
welcome_voice_path = os.path.join(BASE_DIR, "saeed_voice.mp3") # تم التعديل إلى صيغة mp3 الحقيقية
...
# 💡 تشغيل الهوية الصوتية الرسمية الخاصة بك (تظهر وتعمل فوراً لأن الاسم أصبح صحيحاً)
...
if os.path.exists(welcome_voice_path):
    ...
    st.warning("⚠️ جاري تهيئة ملف الصوت الحقيقي saeed_voice.mp3...")
...
if audio:
    ...
    try:
        ...
        system_prompt = (
            ...
            "- ابدأ بمقدمة ثقافية، بليغة، وااحترافية تحمل اسمك (Saeed DataBot) وصانعك (سعيد المسوري).\n"
            "- قم بتشريح وتفصيل ما ورد في الملف الصوتي المرفق (مواصفات، أسعار، أو خطط تسويقية) وصغها في شكل نقاط أو جداول غاية في الأناقة اللغوية والتنظيم.\n"
